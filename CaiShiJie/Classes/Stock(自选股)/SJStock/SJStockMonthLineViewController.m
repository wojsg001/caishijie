//
//  SJStockMonthLineViewController.m
//  QuartzDemo
//
...
@interface SJStockMonthLineViewController ()
...
@implementation SJStockMonthLineViewController
...
- (void)viewDidLoad {
    ...
    [self loadMonthLineData];
}

- (void)loadMonthLineData {
    NSTimeInterval timeInterval = [[NSDate date] timeIntervalSince1970];
    NSString *urlStr = [NSString stringWithFormat:@"https://gupiao.baidu.com/api/stocks/stockmonthbar?from=pc&os_ver=1&cuid=xxx&vv=100&format=json&stock_code=%@&step=3&start=&count=160&fq_type=no&timestamp=%ld", self.stock_code, (long)timeInterval];
