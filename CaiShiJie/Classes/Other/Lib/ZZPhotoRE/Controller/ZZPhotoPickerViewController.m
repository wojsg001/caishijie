...
-(UIButton *)doneBtn{
    if (!_doneBtn) {
        ...
        [_doneBtn setTitleColor:RGB(16, 164, 237) forState:UIControlStateNormal];
...
-(UIButton *)previewBtn{
    if (!_previewBtn) {
        ...
        [_previewBtn setTitleColor:RGB(16, 164, 237) forState:UIControlStateNormal];
...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"nav_box"] forBarMetrics:UIBarMetricsDefault];
    // 设置导航栏中间标题文字的字体、颜色
