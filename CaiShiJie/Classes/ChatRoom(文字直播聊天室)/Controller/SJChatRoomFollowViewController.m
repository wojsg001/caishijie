//
//  SJChatRoomFollowViewController.m
//  CaiShiJie
//
...
#import "SJChatRoomFollowCell.h"
#import "SJhttptool.h"
#import "MJRefresh.h"
#import "MJExtension.h"
#import "SJChatRoomFollowModel.h"
#import "SJMyLiveViewController.h"
#import "SJNewLiveRoomViewController.h"

@interface SJChatRoomFollowViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    int i;
}
...
@implementation SJChatRoomFollowViewController
...
- (void)setUpTableView
{
    ...
    UINib *nib = [UINib nibWithNibName:@"SJChatRoomFollowCell" bundle:nil];
    [self.tableView registerNib:nib forCellReuseIdentifier:@"SJChatRoomFollowCell"];
}
...
- (void)loadMostOpinionLiveData
{
    ...
    [SJhttptool GET:urlStr paramers:dic success:^(id respose) {
        ...
        {
            NSArray *tmpArr = [SJChatRoomFollowModel objectArrayWithKeyValuesArray:respose[@"data"][@"live"]];
...
{
    SJChatRoomFollowCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SJChatRoomFollowCell"];
...
{
    SJChatRoomFollowModel *model = self.dataArray[indexPath.row];
