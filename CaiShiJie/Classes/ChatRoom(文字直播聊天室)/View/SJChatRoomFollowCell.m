...
@interface SJChatRoomFollowCell ()
...
@implementation SJChatRoomFollowCell
...
- (void)setHotOrFireModel:(SJChatRoomFollowModel *)hotOrFireModel {
...
- (void)setModel:(SJChatRoomFollowModel *)model {
    _model = model;
